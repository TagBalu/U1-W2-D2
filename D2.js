...
let number2 = 15;
if (number1 > number2) {
  console.log(number1 + "maggiore" + number2);
} else {
  console.log(number1 + "minore" + number2);
}
/* ESERCIZIO 2
...
/* SCRIVI QUI LA TUA RISPOSTA */
console.log("divisibile", 2 % 5 === 0);
console.log("divisibile", 10 % 5 == 0);
...
const lastIndex = umArray.length - 1;
umArray.splice(lastIndex, 1, 100);
console.log(umArray);
